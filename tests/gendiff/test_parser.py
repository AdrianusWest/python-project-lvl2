...
def test_get_dict_from_datafile():
    assert get_data('./tests/fixtures/plain1.json') == plain1
    assert get_data('./tests/fixtures/plain2.json') == plain2
    assert get_data('./tests/fixtures/plain1.yaml') == plain1
    assert get_data('./tests/fixtures/plain2.yaml') == plain2
    assert get_data('./tests/fixtures/plain1.yml') == plain1
    assert get_data('./tests/fixtures/plain2.yml') == plain2
